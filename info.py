...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002086771619') # support group id ( make sure bot is admin )
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002002335572')) #Log channel id ( make sure bot is admin )
